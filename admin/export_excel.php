<?php
/* Admin: export violations to an Excel (.xlsx) file. */
...
/* ---- .xlsx — ONE export button, filter-aware ----
   ...
   The top of every sheet carries the department name and the date range.
   (severity=… still gives the old Major/Minor workbook if ever needed.) */
...
/* The ?drive=1 upload was removed. Filing straight into Drive needs a
   ...
   downloads; the Drive folder link on the Violations page is the manual
   route. */
